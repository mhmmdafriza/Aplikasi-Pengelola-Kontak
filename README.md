...
# Deskripsi
Aplikasi Pengelola Kontak adalah sebuah perangkat lunak yang dirancang untuk membantu pengguna dalam mengatur dan menyimpan informasi kontak secara efektif. Aplikasi ini memungkinkan pengguna untuk menyimpan data kontak seperti nama, nomor telepon, alamat email, dan informasi tambahan lainnya dalam satu tempat yang mudah diakses.

## Coding Java Frame Aplikasi Pengelola Kontak
```java
                    ...
                    .addGroup(jPanel1LayoutLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1LayoutLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1LayoutLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1LayoutLayout.createSequentialGroup()
